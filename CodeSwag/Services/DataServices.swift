...
class DataService {
    ...
    private let shirts = [
        ...
        Product(title: "Devslopes Logo Shirt Gray", price: "$18", imageName: "shirt02.png"),
        Product(title: "Devslopes Logo Shirt Red", price: "$18", imageName: "shirt03.png"),
        Product(title: "Devslopes Logo Shirt Blue", price: "$18", imageName: "shirt04.png"),
        Product(title: "Devslopes Logo Shirt Green", price: "$18", imageName: "shirt05.png")
    ]
